#Handle numerical and categorical features from data
...
import numpy as np
import pandas as pd
from sklearn.compose import ColumnTransformer #to craete pipeline
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            #pippeline run on train dataset
    ...
    def initiate_data_transformation(self,train_path,test_path,preprocessor_path):
        ...
        try:
            ...
            logging.info('obatining preprocessing object')
